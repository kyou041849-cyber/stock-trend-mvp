...
G009: LLMプロバイダ可変化（OpenAI互換 Chat Completions対応）。
...
| G009 | in-progress | manager | codex-verifiable | G008 merged to main | none | LLMプロバイダ可変化（OpenAI互換 Chat Completions対応） | local implementation and validation completed; PR and CI pending | [goals/G009_LLM_PROVIDER_CONFIG.md](goals/G009_LLM_PROVIDER_CONFIG.md) |
...
| ID | Status | Owner | Acceptance | Depends On | Outcome | Evidence |
|---|---|---|---|---|---|---|
| G009 | in-progress | manager | codex-verifiable | G008 merged to main | LLMプロバイダ可変化（OpenAI互換 Chat Completions対応） | local implementation and validation succeeded; PR and CI pending |
