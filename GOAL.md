...
| G007 | running | manager | codex-verifiable | G006 merged to main | none | 実株価データ接続（日本株 + 米国株） | branch `codex/g007-realdata-jp-us`; JP/US ticker, region, currency, fixture/stub tests in progress | [goals/G007_REALDATA_JP_US.md](goals/G007_REALDATA_JP_US.md) |
