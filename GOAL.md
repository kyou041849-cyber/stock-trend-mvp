...
G010: RSI/SMAクロスをトレンド強さスコアへ加点（モメンタム確認方式）。
...
| G010 | in-progress | manager | codex-verifiable | G009 merged to main | none | RSI/SMAクロスをトレンド強さスコアへ加点 | local validation succeeded; PR and CI pending | [goals/G010_INDICATOR_SCORING.md](goals/G010_INDICATOR_SCORING.md) |
...
| ID | Status | Owner | Acceptance | Depends On | Outcome | Evidence |
|---|---|---|---|---|---|---|
| G010 | in-progress | manager | codex-verifiable | G009 merged to main | RSI/SMAクロスをトレンド強さスコアへ加点 | local validation succeeded; PR and CI pending |
